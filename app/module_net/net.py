...
def getNetFieldList(host, port, user, password, dbname):
	client = DataFrameClient(host, port, user, password, dbname)
	query ="show field keys from net"
	data = client.query(query)
	dataframe = data['net']
	field_list = []
	for x in dataframe:
...
def net_arima(host, port, user, password, dbname, query,number_of_prediction):
...
def net_ar(host, port, user, password, dbname, query,number_of_prediction):
...
def net_ma(host, port, user, password, dbname, query,number_of_prediction):
...
def net_holt(host, port, user, password, dbname , query,number_of_prediction):
	client = DataFrameClient(host, port, user, password, dbname)
	data = client.query(query)
	dataframe = data['net']
	dict={}
